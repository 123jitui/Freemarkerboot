...
// 
		...
		public String addsave(@Validated User user, BindingResult bindingResult, @RequestParam("fileHead") MultipartFile multipartFile, Map<String, Object> map) throws Exception {
